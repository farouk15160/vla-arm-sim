...
WORLD_BOXES: list[WorldBox] = [
    ...
    # Room walls, far outside the arm's ~0.85 m reach. Registered as collision
    # objects too: harmless for planning, and it keeps RViz honest.
    WorldBox("wall_far", (0.06, 6.0, 2.8), (2.10, 0.0, 1.40), (0.60, 0.62, 0.66, 1.0)),
    WorldBox("wall_right", (6.0, 0.06, 2.8), (0.0, -2.00, 1.40), (0.60, 0.62, 0.66, 1.0)),
    WorldBox("wall_back", (0.06, 6.0, 2.8), (-1.60, 0.0, 1.40), (0.60, 0.62, 0.66, 1.0)),
